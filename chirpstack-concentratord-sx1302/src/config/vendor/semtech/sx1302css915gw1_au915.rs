...
// based off: https://github.com/helium/sx1302_hal/blob/jsc/merge-semtech-upstream/packet_forwarder/global_conf.json.sx1250.AU915
pub fn new(conf: &config::Configuration) -> Configuration {
    warn!("Deprecation warning: please use model semtech_sx1302css915gw1 and specify region");
