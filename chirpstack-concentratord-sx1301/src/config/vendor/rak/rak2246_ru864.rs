...
// source:
// https://github.com/RAKWireless/rak_common_for_gateway/blob/7f110c2f00/lora/rak2246/global_conf/global_conf.ru_864_870.json
pub fn new(conf: &config::Configuration) -> Configuration {
    ...
    Configuration {
        ...
        radio_min_max_tx_freq: vec![(864000000, 870000000), (864000000, 870000000)],
